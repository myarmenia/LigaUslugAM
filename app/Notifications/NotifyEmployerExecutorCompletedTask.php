...
class NotifyEmployerExecutorCompletedTask extends Notification
{
    use Queueable;
    ...
    {
        if($this->task->users->geting_notification==1){
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)->subject('Исполнитель завершил задание')->view('Mails.notifyemployerexecutorcompletedtask',['task'=> $this->task,'logo'=>'/images/logo_footer.png']);
    }
    public function toDatabase($notifiable)
    {
        ...
        return
            [
                ...
                'from_executor'=>$this->task->executor_profiles->users->name.' '.$this->task->executor_profiles->users->last_name
            ];
