    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div style="margin-top:20px"><button type="button" class="btn" style="background-color: #4B9A2D;border-radius:15px;padding:5px 8px; border:none;outline:none"><a href="{{route('verification.verify')}}" style="color:white;text-decoration:none">email verifed</a></button></div>
