        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-xs-12  mb-3">
                   <h3>Уважаемый(ая) {{$donated->executor_profiles->users->name.' '.$donated->executor_profiles->users->last_name}}</h3>
                    <p class="m-2">Вы заполнили 70% анкеты и Ваш счет пополнен на '{{$donated->donated_money}}' рублей.</p>
